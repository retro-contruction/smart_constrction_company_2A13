...
Smtpreset::Smtpreset( const QString &from, const QString &to, const QString &subject, const QString &body )
{
...
void Smtpreset::stateChanged(QTcpSocket::SocketState socketState)
{

    qDebug() <<"stateChanged " << socketState;
}

void Smtpreset::errorReceived(QTcpSocket::SocketError socketError)
{
    qDebug() << "error " <<socketError;
}

void Smtpreset::disconnected()
{
...
void Smtpreset::connected()
{
    //output->append("connected");
    qDebug() << "Connected ";
}

void Smtpreset::readyRead()
{
