...
void Form::on_pushButton_122_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}
/////////////////////////////////////////////////////////////////////// partie arwa

void Form::on_pushButton_ajouter_a_clicked()
{
...
void Form::on_pushButton_modifier_a_clicked()
{
...
void Form::on_pushButton_supprimer_a_clicked()
{
...
void Form::on_pushButton_rechercher_a_clicked()
{
...
void Form::on_pushButton_tri_a_clicked()
{
    ui->tableView_a->setModel(Etmp.trie());
}

void Form::on_pushButton_excel_a_clicked()
{
...
void Form::on_pushButton_pdf_a_clicked()
{
    QPrinter print;
...
void Form::on_pushButton_afficher_a_clicked()
{
    ui->tableView_a->setModel(Etmp.afficher()); //afficher normale
}

void Form::on_push_afficher_archive_a_clicked()
{
    ui->tableView_a->setModel(Etmp.AfficherArchive());
}

void Form::on_push_archiver_a_clicked()
{
...
void Form::on_push_Desar_a_clicked()
{
    int id = ui->tableView_a->model()->data(ui->tableView_a->model()->index(ui->tableView_a->currentIndex().row(),0)).toInt();
    int montant = ui->tableView_a->model()->data(ui->tableView_a->model()->index(ui->tableView_a->currentIndex().row(),1)).toInt();
...
void Form::on_pushButton_76_clicked()
{
    ui->stackedWidget->setCurrentIndex(8);
}
