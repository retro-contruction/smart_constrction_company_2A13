    ...
    , ui(new Ui::Form)
{
    ...
    ui->tableView_19->setModel(e.afficher());
    ui->comboBox_17->setModel(e.afficher());
    ui->comboBox_18->setModel(p.afficher());
    ui->comboBox_19->setModel(t.afficher2());
    ui->comboBox_20->setModel(e.afficher());
    ui->tableView_20->setModel(t.afficher3());
    ui->tableView_21->setModel(t.afficher());
    //sof
...
void Form::on_pushButton_118_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);
}

void Form::on_pushButton_120_clicked()
{
    ui->stackedWidget->setCurrentIndex(2);
     notification();
}
...
void Form::on_pushButton_73_clicked()
{
    ui->stackedWidget->setCurrentIndex(8);
}

void Form::on_lineEdit_36_textChanged(const QString &arg1)
{
    projet p;
    ui->tableView_2->setModel(p.recherche(arg1));
}

void Form::on_pushButton_150_clicked()
{
    projet p;
    ui->tableView_2->setModel(p.trie());
}

void Form::on_pushButton_149_clicked()
{
    projet p;
    ui->tableView_2->setModel(p.afficher());
}

void Form::on_pushButton_155_clicked()
{
    Employes el;
    QString p= ui->comboBox_18->currentText();
    QString e= ui->comboBox_17->currentText();
    el.update(p,e);
    ui->tableView_19->setModel(el.afficher());
    ui->comboBox_20->setModel(el.afficher());
}

void Form::on_pushButton_156_clicked()
{
    task t2;
    QString tid= ui->lineEdit_39->text();
    QString t= ui->textEdit_9->toPlainText();
    t2.insert(tid,t);
    ui->tableView_20->setModel(t2.afficher3());
}

void Form::on_pushButton_157_clicked()
{
    task tl;
    QString t= ui->comboBox_19->currentText();
    QString e= ui->comboBox_20->currentText();
    tl.update(t,e);
    ui->tableView_21->setModel(tl.afficher());
}

void Form::on_pushButton_158_clicked()
{
    projet p;
    QLabel* label_47 = new QLabel;
    QLabel* label_48 = new QLabel;
    QString ID= ui->lineEdit_38->text();
    QString res= ui->lineEdit_37->text();
    QString ID_PROJET,RESPONSABLE;
    if (ID.isEmpty())
    {
        ui->label_47->setStyleSheet("QLabel { background-color : red; color : red; }");

    }
    else
    {
        ui->label_47->setStyleSheet("QLabel { background-color : green; color : green; }");
         ID_PROJET=ID;
    }
    if (res.isEmpty())
    {
        ui->label_48->setStyleSheet("QLabel { background-color : red; color : red; }");

    }
    else
    {
        ui->label_48->setStyleSheet("QLabel { background-color : green; color : green; }");
         RESPONSABLE=res;
    }
    QString DATE_DEBUT= ui->dateEdit_17->text();
    QString DATE_ESTIMATION= ui->dateEdit_16->text();
    QString DATE_FIN= ui->dateEdit_18->text();
    p.ajout(ID_PROJET,RESPONSABLE,DATE_DEBUT,DATE_ESTIMATION,DATE_FIN);
    ui->tableView_2->setModel(p.afficher());

}

void Form::on_pushButton_77_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);
}

void Form::on_pushButton_121_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
}
...
//sofien
void Form::on_pushButton_36clicked()
{
    QString plan;
...
void Form::on_AjouterTerrain_clicked()
{
...
void Form::on_id_Supprimer_clicked()
{
...
void Form::on_pushButtonModifier_clicked()
{
    QString id,ville,adresse;
    QFile plan;
    int dimension,etat;
...
void Form::on_buttStatistique_clicked()
{
...
void Form::on_trier_2_clicked()
{
    ui->tableTerrain->setModel(T.tri_dimdesc());

}

void Form::on_pushButton_map_clicked()
{
    //maps= new map(this);
   // maps->show();
}

void Form::on_pushButton_pdf_clicked()
{
   Terrain t;
...
/*
void Form::on_pushButton_excel_clicked()
{
...
void Form::on_pushButton_71_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
...
void Form::on_pushButton_75_clicked()
{
    ui->stackedWidget->setCurrentIndex(4);

}

void Form::on_pushButton_78_clicked()
{
    ui->stackedWidget->setCurrentIndex(5);
...
void Form::on_pushButton_80_clicked()
{
    ui->stackedWidget->setCurrentIndex(9);
}
